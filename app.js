...
function fetchOneProduct($id) {
    ...
    $.ajax({
        ...
        success: function(data){
           ...
           '                 <h3 class="product-title" class="col-sm-6" style="margin-top: 10px">'+item['title']+'</h3\n'+
           '                 <div class="rating">\n'+
           '                     <button class="btn btn-info" id="comment" onclick="fetchComments('+item['id']+')">Comments</button>\n'+
           '                 <div ></div>'+'</div>\n'+
           '                          <div class="col-sm-6"></div>'+
           '                         <h5 class="price">Current Price: <span>'+item['price']+'</span style="float: right";></h5>\n'+
           '                            <div class="col-sm-6"></div>'+
           ...
           '                          <div class="col-sm-6"></div>'+
           '                        <div class="action">\n'+
           '                     <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal"data-whatever="$id">Submit Comment</button>\n'+
           '                 </div>\n'+
           '             </div>\n'+
           '         </div>\n'+
           '     </div>\n'+
...
function addToCart($id) {
    ...
    if( email !='' ) {
        ...
        sessionStorage.setItem("cart", 10);
        ...
        $.ajax({
            ...
            async: true,
            global: false,
            data: JSON.stringify({"product_id": $id, "email": emails}),
            contentType: 'text/plain',
        ...
        alert('Please enter your email at the top of page');
    }
